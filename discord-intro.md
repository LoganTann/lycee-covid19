...
* **Sur mobile** : télécharger l'application Discord via le [Google Play (pour Android)](https://play.google.com/store/apps/details?id=com.discord) Un bouton de création de compte est affiché.
...
> D'autres services de drive/cloud peuvent aussi être utilisé (comme Dropbox ou Mega) mais il est recommandé d'utilser les deux cité dessus.
